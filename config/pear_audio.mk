...
ALARM_PATH := vendor/pear/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/pear/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/pear/prebuilt/common/media/audio/ringtones
